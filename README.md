...
- **Groq SDK** - Интеграция с AI моделями (Moonshot AI) для генерации персонализированных советов
...
│   └── schema.prisma      # Схема базы данных (модели users, octalysis_factors)
...
│   │   └── route.ts       # ИИ-Мудрец (получение совета)
...
│   ├── groq.ts          # Сервис для работы с Groq AI
...
model users {
  ...
  character_class  String?           // Класс персонажа (например, "Мастер алгоритмов")
...
- [ ] Групповые челленджи
- [ ] Система достижений
- [ ] AI-ассистент для интерпретации результатов октаграммы (реализовано)
