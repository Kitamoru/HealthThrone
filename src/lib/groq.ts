...
☑ Я начал с эмпатии, а не с анализа?
☑ Класс "${className}" и истинный архетип (определённый по профилю) упомянуты органично?
  * Если они совпадают — подчеркнул это как силу?
  * Если расходятся — представил как мягкое открытие, без оценок?
☑ Каждый квест содержит конкретный микро-шаг (что именно делать)?
☑ Длина ответа около 500 слов?
☑ Между блоками есть пустые строки?
☑ Ответ звучит как разговор с мудрым другом, а не отчёт системы?
☑ Если в профиле указаны скрытые боли (дефицит автономии, компетентности или связанности) — есть ли квест, который адресует эту потребность?
☑ Каждую метафору можно нарисовать, она логична и не смешивает разные домены?
