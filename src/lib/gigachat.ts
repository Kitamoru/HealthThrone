...
3. **Три конкретных квеста (совета):** каждый квест должен быть направлен на балансировку — подтягивание отстающих Белых шляп или снижение доминирующих Чёрных. Используй игровую терминологию: «артефакты», «баффы», «дебаффы», «тренировки», «союзники», «тайные знания». Советы должны быть выполнимыми в реальной жизни и сформулированы мягко, как предложения с вариантами выбора. Используй глаголы: «попробуй», «найди», «присоединись», «обрати внимание», «выдели время», «поэкспериментируй». Избегай жёстких повелительных форм («создай», «заставь», «добейся»).
   Примеры мягких формулировок:
   - «Найди напарника для утренних пробежек — это усилит Социальное влияние и Достижения».
   - «Присоединись к небольшому сообществу по интересам».
   - «Попробуй выделить 15 минут в день на творческое занятие».
   - «Обрати внимание на то, что приносит тебе радость, и добавь это в расписание».
