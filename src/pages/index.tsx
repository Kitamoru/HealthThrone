...
const Home = () => {
  ...
  const handleOctalysisInfo = useCallback(() => {
    alert("Добро пожаловать, герой!  Ты вступаешь в мир, где каждая задача — это квест, а твоя воля и страсть определят судьбу великих свершений. Восемь путеводных звёзд вдохновят тебя на подвиги. Если звезда тускнеет, следуй их советам, чтобы вновь зажечь пламя! Иди вперёд, герой, и пусть звёзды карты октализа освещают твой путь к величию!");
  }, []);
