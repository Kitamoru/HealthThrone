...
const Home = () => {
  ...
  const handleOctalysisInfo = useCallback(() => {
    alert("Октализ — 8 мотиваторов, которые делают твою работу увлекательной: от чувства прогресса до творчества и командного духа. Используй их, чтобы найти драйв и получать кайф от задач!  Зачем?  Пойми, что тебя мотивирует. Преврати рутину в интересное дело.  Делай задачи с удовольствием.");
  }, []);
