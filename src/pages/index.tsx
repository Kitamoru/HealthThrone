...
const Home = () => {
  ...
  const handleOctalysisInfo = useCallback(() => {
    alert("Добро пожаловать, герой!\n\nТы вступаешь в&nbspмир, где&nbspкаждая задача — это квест, а твоя воля и страсть определят судьбу великих свершений. Восемь путеводных звёзд вдохновят тебя на подвиги. Если звезда тускнеет, следуй их советам, чтобы вновь зажечь пламя!\n\nИди вперёд, герой, и пусть звёзды карты октализа освещают твой путь к величию!");
  }, []);
