          ...
          <div className="reference-section">
            ...
            <div className="reference-card">
              ...
              <ul className="feature-list">
                ...
                <li>Ответы влияют на уровень энергии и <strong>мотивационные факторы</strong></li>
                <li>Визуализация уровня энергии</li>
          ...
          <div className="reference-section">
            ...
            <div className="reference-card">
              ...
              <ul className="feature-list">
                ...
                <li>Классы - это отражение вашей ведущей мотивации</li>
